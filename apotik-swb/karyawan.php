...
$obj->karyawan();
?>
<a href="tambah_karyawan.php" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-plus-sign tag_01"></span>Tambah Data</a>
<a href="export_karyawan.php" class="btn btn-sm btn-info"><span class="glyphicon glyphicon-print tag_01"></span>Cetak</a>
<br><br>
...
<tbody>
    <tr>
        ...
        <td>
        <a href="update_karyawan.php?idKaryawan=<?php echo $idKaryawan;?>"><img src="images/pencil.gif"></a>&nbsp;
        <a href="delete_karyawan.php?idKaryawan=<?php echo $idKaryawan;?>" 
