...
<?php 
 ...
 if(isset($_REQUEST['submit'])){
    ...
    extract($_REQUEST);
    $obj->update_karyawan($nokaryawan,$nama,$jk,$tmplahir,$tgllahir,$alamat,$telepon,$user,$pass,$profesi);
    }

if(isset($_REQUEST['idKaryawan'])){
    $idKaryawan=$_REQUEST['idKaryawan'];
    $result=$obj->mysqli->query("SELECT * from karyawan where idKaryawan='$idKaryawan'");
...
<div class="graphs">
    <div class="bs-example4" data-example-id="simple-responsive-table">
        <h3>Forms Update Karyawan</h3>
        <div class="tab-content">
            <div class="tab-pane active" id="horizontal-form">
                <!-- Form action -->
                <form class="form-horizontal" action="update_karyawan.php">
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Id Karyawan</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" name="nokaryawan" 
                             value="<?php echo $idKaryawan; ?>"  readonly/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Nama</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" name="nama"  
                   ...
                   <div class="form-group">
                        <label for="radio" class="col-sm-2 control-label">Jenis Kelamin</label>
                            <div class="col-sm-8">
<?php
if( $jenisKelamin == 'laki-laki') /*jika jenis kelamin = laki-laki*/
{
echo ' <div class="radio block"><label><input type="radio" name="jk" required value="laki-laki" checked>Laki-Laki</label></div>
       <div class="radio block"><label><input type="radio" name="jk" value="Perempuan" />Perempuan</label></div>';
}
else /*jika tidak maka akan tampil perempuan*/
{
echo '<div class="radio block"><label><input type="radio" name="jk" required value="Perempuan" checked>Perempuan</label></div>
      <div class="radio block"><label><input type="radio" name="jk" value="laki-laki" />Laki-Laki</label></div>';
}
?>  
                    </div> 
                </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-8"> 
                            <input type="text" class="form-control1"  placeholder="tempat lahir" name="tmplahir" 
                            value="<?php echo $tmpLahir;?>" required>
                        </div>
                    </div>
                     <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Tanggal Lahir</label>
                        <div class="col-sm-8">
                            <input type="date" class="form-control1" name="tgllahir" value="<?php echo $tglLahir;?>" required>
                        </div>
                    </div>
                     <div class="form-group">
                            <label for="txtarea1" class="col-sm-2 control-label">Alamat</label>
                            <div class="col-sm-8">
                            <textarea class="form-control1" name="alamat" required><?php echo $alamat;?></textarea>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control1"  placeholder="username" name="user" 
                    ...
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Profesi</label>
                        <div class="col-sm-8">
                           <select name="profesi" class="form-control1" required>
                                <option><?php echo $profesi;?></option>
