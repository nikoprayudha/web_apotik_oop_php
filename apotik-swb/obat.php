...
$obj->obat();
?>
<a href="tambah_obat.php" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-plus-sign tag_01"></span>Tambah Data</a>
<a href="export_obat.php" class="btn btn-sm btn-info"><span class="glyphicon glyphicon-print tag_01"></span>Cetak</a>
<br><br>
...
<tbody>
    <tr>
        ...
        <td><?php echo $stok; ?></td>
        <td>
        <a href="update_obat.php?idObat=<?php echo $idObat;?>"><img src="images/pencil.gif"></a>&nbsp;
        <a href="delete_obat.php?idObat=<?php echo $idObat;?>" 
