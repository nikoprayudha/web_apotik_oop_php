...
<?php 
 ...
 if(isset($_REQUEST['submit'])){
    ...
    extract($_REQUEST);
    $obj->update_pelanggan($pelangganid,$nama,$jk,$alamat,$keluhan,$telepon);
    }

if(isset($_REQUEST['idPelanggan'])){
    $idPelanggan=$_REQUEST['idPelanggan'];
    $result=$obj->mysqli->query("SELECT * from pelanggan where idPelanggan='$idPelanggan'");
...
<div class="graphs">
    <div class="bs-example4" data-example-id="simple-responsive-table">
        <h3>Forms Update Pelanggan</h3>
        <div class="tab-content">
            <div class="tab-pane active" id="horizontal-form">
                <!-- form action -->
                <form class="form-horizontal" action="update_pelanggan.php">
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Id Pelanggan</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" placeholder="Id Pelanggan" name="pelangganid" 
                            value="<?php echo $idPelanggan; ?>" readonly >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Nama</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1"  placeholder="nama" name="nama" value="<?php echo $nama; ?>"
                            required>
                        </div>
                    </div>
                 <div class="form-group">
...
?>  
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control1"  placeholder="keluhan" name="keluhan" value="<?php echo $keluhan; ?>"
                            required>
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control1"  placeholder="telepon" name="telepon" value="<?php echo $telepon; ?>"
                             required>
                        </div>
                    </div>
