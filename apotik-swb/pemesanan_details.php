        ...
        <div class="graphs">
            <div class="bs-example4" data-example-id="simple-responsive-table">
                <div class="table-responsive">
                    <h2>Tabel Pemesanan Details</h2>
                 
                    <br>
<?php
include('crud_class.php');
$obj=new Crud("localhost","root","","apotik");
$obj->pemesanan_details();
?>
<a href="tambah_pemesanandetails.php" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-plus-sign tag_01"></span>Tambah Data</a>
<a href="#" class="btn btn-sm btn-info"><span class="glyphicon glyphicon-print tag_01"></span>Cetak</a>
<br><br>
<table class="table table-bordered">
    <thead>
        <tr>

            <th>Id Pemesanan Details</th>
            <th>Id Pemesanan</th>
            <th>Id Obat</th>
            <th>Nama Obat</th>
            <th>Jumlah</th>
...
<tbody>
    <tr>
        <td><?php echo $idPemesanandetails; ?></td>
        <td><?php echo $idPemesanan; ?></td>
        ...
        <td>
        <a href="update_pemesanandetails.php?idPemesanandetails=<?php echo $idPemesanandetails;?>">
        <img src="images/pencil.gif"></a>&nbsp;
        <a href="delete_pemesanandetails.php?idPemesanandetails=<?php echo $idPemesanandetails;?>" 
