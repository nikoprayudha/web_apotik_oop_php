...
$obj->penjualan();
?>
<a href="tambah_penjualan.php" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-plus-sign tag_01"></span>Tambah Data</a>
...
<tbody>
    <tr>
        ...
        <td>
        <a href="delete_penjualan.php?idPenjualan=<?php echo $idPenjualan;?>" 
