...
<?php 
 ...
 if(isset($_REQUEST['submit'])){
    ...
    extract($_REQUEST);
    $obj->tambah_profesikrw($profesiid,$karyawanid,$profesi);
...
<div class="graphs">
    <div class="bs-example4" data-example-id="simple-responsive-table">
        <h3>Forms Tambah Pofesi Karyawan</h3>
        <div class="tab-content">
            <div class="tab-pane active" id="horizontal-form">
                <!-- form action -->
                <form class="form-horizontal" action="tambah_profesikrw.php">
                    
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Id Profesi Karyawan</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" placeholder="Id Profesi karyawan" name="profesiid" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                       ...
                       <div class="col-sm-8">
                        ...
                        <select class="form-control1" name="karyawanid" required>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control1"  placeholder="Profesi" name="profesi" required>
                        </div>
                    </div>
