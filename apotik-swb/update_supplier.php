...
<?php 
 ...
 if(isset($_REQUEST['submit'])){
    ...
    extract($_REQUEST);
    $obj->update_supplier($supplierid,$nama,$jk,$perusahaan,$alamat,$telepon);
    }

if(isset($_REQUEST['idSupplier'])){
    $idSupplier=$_REQUEST['idSupplier'];
    $result=$obj->mysqli->query("SELECT * from supplier where idSupplier='$idSupplier'");
...
<div class="graphs">
    <div class="bs-example4" data-example-id="simple-responsive-table">
        <h3>Forms Update Supplier</h3>
        <div class="tab-content">
            <div class="tab-pane active" id="horizontal-form">
                <!-- form action -->
                <form class="form-horizontal" action="update_supplier.php">
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Id Supplier</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" placeholder="Id Suppler" name="supplierid" 
                            value="<?php echo $idSupplier ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Nama</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1"  placeholder="nama" name="nama" 
...
?>  
                     ...
                     <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Perusahaan</label>
                        <div class="col-sm-8"> 
                            <input type="text" class="form-control1"  placeholder="Perusahaan" name="perusahaan" 
                            value="<?php echo $perusahaan ?>" required>
                        </div>
                    </div>
                    
                     <div class="form-group">
                            <label for="txtarea1" class="col-sm-2 control-label">Alamat</label>
                            <div class="col-sm-8"><textarea class="form-control1" name="alamat" required><?php echo $alamat ?></textarea>
                            </div>
                    </div>
                     <div class="form-group">
