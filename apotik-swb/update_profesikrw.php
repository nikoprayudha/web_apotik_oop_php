...
<?php 
 ...
 if(isset($_REQUEST['submit'])){
    ...
    extract($_REQUEST);
    $obj->update_profesikrw($profesiid,$karyawanid,$profesi);
    }

if(isset($_REQUEST['idProfesikrw'])){
    $idProfesikrw=$_REQUEST['idProfesikrw'];
    $result=$obj->mysqli->query("SELECT * from profesikrw where idProfesikrw='$idProfesikrw'");
...
<div class="graphs">
    <div class="bs-example4" data-example-id="simple-responsive-table">
        <h3>Forms Update Pofesi Karyawan</h3>
        <div class="tab-content">
            <div class="tab-pane active" id="horizontal-form">
                <!-- form action -->
                <form class="form-horizontal" action="update_profesikrw.php">
                    
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Id Profesi Karyawan</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" placeholder="Id Profesi karyawan" name="profesiid" 
                            value="<?php echo $idProfesikrw; ?>"  readonly/>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="selector1" class="col-sm-2 control-label">Id karyawan</label>
                       <div class="col-sm-8">
                        
                        <select class="form-control1" name="karyawanid" value="<?php echo $idKaryawan; ?>" required>     

                                <?php
                                $obj=new mysqli("localhost","root","","apotik");
                                $queryusers = "SELECT * FROM karyawan ";
                                $obj = mysqli_query($obj, $queryusers);
                                while ( $d=mysqli_fetch_assoc($obj)) {
                                echo "<option>".$d['idKaryawan']."</option>";
                                }
                                ?>
                        </select>
                        </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control1"  placeholder="Profesi" name="profesi" 
                             value="<?php echo $profesi; ?>" required>
                        </div>
                    </div>
