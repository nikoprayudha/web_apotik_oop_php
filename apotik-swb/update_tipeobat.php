...
<?php 
 ...
 if(isset($_REQUEST['submit'])){
    ...
    extract($_REQUEST);
    $obj->update_tipeobat($tipeobatid,$tipe);
    }

if(isset($_REQUEST['idTipeobat'])){
    $idTipeobat=$_REQUEST['idTipeobat'];
    $result=$obj->mysqli->query("SELECT * from tipeobat where idTipeobat='$idTipeobat'");
...
<div class="graphs">
    <div class="bs-example4" data-example-id="simple-responsive-table">
        <h3>Forms Update Tipe Obat</h3>
        <div class="tab-content">
            <div class="tab-pane active" id="horizontal-form">
                <!-- form action -->
                <form class="form-horizontal" action="update_tipeobat.php">
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Id Tipe Obat</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" placeholder="Id TipeObat" name="tipeobatid"
                            value="<?php echo $idTipeobat; ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Tipe</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1"  placeholder="tipe" name="tipe" 
                            value="<?php echo $tipe; ?>" required>
                        </div>
                    </div>
