...
?>
<a href="tambah_penjualandetails.php" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-plus-sign tag_01"></span>Tambah Data</a>
...
<tbody>
    <tr>
        ...
        <td>
        <a href="tampil_penjualandetail_kasir.php?idPenjualandetails=<?php echo $idPenjualandetails;?>">Detail</a>&nbsp;      
        <a href="delete_penjualandetails.php?idPenjualandetails=<?php echo $idPenjualandetails;?>" 
