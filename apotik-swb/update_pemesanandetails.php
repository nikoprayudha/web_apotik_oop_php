...
<?php 
 ...
 if(isset($_REQUEST['submit'])){
    ...
    extract($_REQUEST);
    $obj->update_pemesanandetails($pemesanandetailsid,$pemesananid,$obatid,$jumlah,$hargabeli,$grandtotal,$bayar,$kembalian);
    }

if(isset($_REQUEST['idPemesanandetails'])){
    $idPemesanandetails=$_REQUEST['idPemesanandetails'];
    $result=$obj->mysqli->query("SELECT * from pemesanandetails where idPemesanandetails='$idPemesanandetails'");
...
<div class="graphs">
    <div class="bs-example4" data-example-id="simple-responsive-table">
        <h3>Forms Update Pemesanan Details</h3>
        <div class="tab-content">
            <div class="tab-pane active" id="horizontal-form">
                <!-- form action -->
                <form class="form-horizontal" action="update_pemesanandetails.php">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            name="pemesanandetailsid" value="<?php echo $idPemesanandetails; ?>" readonly required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                       ...
                       <div class="col-sm-8">
                        ...
                        <select class="form-control1" name="pemesananid" required>
                                <option value =""><?php echo $idPemesanan; ?></option>
                    ...
                    <div class="form-group">
                       ...
                       <div class="col-sm-8">
                        ...
                        <select class="form-control1" name="obatid" required>
                                <option value =""><?php echo $idObat; ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control1"  placeholder="Jumlah" name="jumlah" id="jumlah" onkeyup="kali();" value="<?php echo $jumlah; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control1"  placeholder="Harga Beli" name="hargabeli"  id="hargabeli" onkeyup="kali();" value="<?php echo $hargaBeli; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control1"  placeholder="Grand Total" name="grandtotal" id="grandtotal" onkeyup="kurang()" value="<?php echo $grandTotal; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control1"  placeholder="Bayar" name="bayar"  id="bayar" onkeyup="kurang()" value="<?php echo $bayar; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control1"  placeholder="Kembalian" name="kembalian" id="kembalian" 
                            value="<?php echo $kembalian; ?>" required>
                        </div>
                    </div>
