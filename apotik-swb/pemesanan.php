...
$obj->pemesanan();
?>
<a href="tambah_pemesanan.php" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-plus-sign tag_01"></span>Tambah Data</a>
...
<tbody>
    <tr>
        ...
        <td><?php echo $tglPemesanan; ?></td>
        <td>
        <a href="update_pemesanan.php?idPemesanan=<?php echo $idPemesanan;?>"><img src="images/pencil.gif"></a>&nbsp;
        <a href="delete_pemesanan.php?idPemesanan=<?php echo $idPemesanan;?>" 
