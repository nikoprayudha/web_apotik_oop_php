...
<?php 
 ...
 if(isset($_REQUEST['submit'])){
    ...
    extract($_REQUEST);
    $obj->tambah_pemesanan($pemesananid,$supplierid,$profesiid,$tglpemesanan);
...
<div class="graphs">
    <div class="bs-example4" data-example-id="simple-responsive-table">
        <h3>Forms Tambah Pemesanan</h3>
        <div class="tab-content">
            <div class="tab-pane active" id="horizontal-form">
                <!-- form action -->
                <form class="form-horizontal" action="tambah_pemesanan.php">
                    
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Id Pemesanan</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" placeholder="Id Profesi karyawan" name="pemesananid" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                       ...
                       <div class="col-sm-8">
                        ...
                        <select class="form-control1" name="supplierid" required>
                    ...
                    <div class="form-group">
                       ...
                       <div class="col-sm-8">
                        ...
                        <select class="form-control1" name="profesiid" required>
                                <option value ="">---PILIH ID Profesi ---</option>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="date" class="form-control1"  name="tglpemesanan" required>
                        </div>
                    </div>
