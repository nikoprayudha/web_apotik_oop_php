...
<?php 
 ...
 if(isset($_REQUEST['submit'])){
    ...
    extract($_REQUEST);
    $obj->tambah_kategoriobat($kategoriid,$kategori);
    }
?>
...
<div class="graphs">
    <div class="bs-example4" data-example-id="simple-responsive-table">
        <h3>Forms Tambah Kategori Obat</h3>
        <div class="tab-content">
            <div class="tab-pane active" id="horizontal-form">
                <!-- form action -->
                <form class="form-horizontal" action="tambah_kategoriobat.php">
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Id Kategori Obat</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" placeholder="Id KategoriObat" name="kategoriid" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Kategori</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1"  placeholder="kategori" name="kategori" required>
                        </div>
                    </div>
