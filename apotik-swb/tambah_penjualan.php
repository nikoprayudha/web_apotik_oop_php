...
<?php 
 ...
 if(isset($_REQUEST['submit'])){
    ...
    extract($_REQUEST);
    $obj->tambah_penjualan($penjualanid,$pelangganid,$profesiid,$tglpenjualan);
...
<div class="graphs">
    <div class="bs-example4" data-example-id="simple-responsive-table">
        <h3>Forms Tambah Penjualan</h3>
        <div class="tab-content">
            <div class="tab-pane active" id="horizontal-form">
                <!-- form action -->
                <form class="form-horizontal" action="tambah_penjualan.php">
                    
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Id Penjualan</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" placeholder="Id Penjualan" name="penjualanid" required>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="selector1" class="col-sm-2 control-label">Id Pelanggan</label>
                       <div class="col-sm-8">
                        
                        <select class="form-control1" name="pelangganid" required>
                                <option value ="">---PILIH ID Pelanggan ---</option>

                                <?php
                                $obj=new mysqli("localhost","root","","apotik");
                                $queryusers = "SELECT * FROM pelanggan ";
                                $obj = mysqli_query($obj, $queryusers);
                                while ( $d=mysqli_fetch_assoc($obj)) {
                                echo "<option>".$d['idPelanggan']."</option>";
                                }
                                ?> 
                        </select>
                        </div>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Tanggal Penjualan</label>
                        <div class="col-sm-8">
                            <input type="date" class="form-control1"  name="tglpenjualan" required>
                        </div>
                    </div>
