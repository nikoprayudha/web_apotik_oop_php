...
<?php 
 ...
 if(isset($_REQUEST['submit'])){
    ...
    extract($_REQUEST);
    $obj->tambah_supplier($supplierid,$nama,$jk,$perusahaan,$alamat,$telepon);
    }
?>
...
<div class="graphs">
    <div class="bs-example4" data-example-id="simple-responsive-table">
        <h3>Forms Tambah Supplier</h3>
        <div class="tab-content">
            <div class="tab-pane active" id="horizontal-form"\>
                <!-- form action -->
                <form class="form-horizontal" action="tambah_supplier.php">
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Id Supplier</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" placeholder="Id Suppler" name="supplierid" required>
                        </div>
                    </div>
                    <div class="form-group">
                   ...
                   <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-8"> 
                            <input type="text" class="form-control1"  placeholder="Perusahaan" name="perusahaan" required>
                        </div>
                    </div>
