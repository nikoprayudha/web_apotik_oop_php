...
$obj->kategori_obat();
?>
<a href="tambah_kategoriobat.php" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-plus-sign tag_01"></span>Tambah Data</a>
<br><br>
...
<tbody>
    <tr>
        <td><?php echo $idKategoriobat; ?></td>
        <td><?php echo $kategori; ?></td>
        <td>
        <a href="update_kategoriobat.php?idKategoriobat=<?php echo $idKategoriobat;?>"><img src="images/pencil.gif"></a>&nbsp;
        <a href="delete_kategoriobat.php?idKategoriobat=<?php echo $idKategoriobat;?>" 
