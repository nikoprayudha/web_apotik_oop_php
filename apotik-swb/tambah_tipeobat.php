...
<?php 
 ...
 if(isset($_REQUEST['submit'])){
    ...
    extract($_REQUEST);
    $obj->tambah_tipeobat($tipeobatid,$tipe);
    }
?>
...
<div class="graphs">
    <div class="bs-example4" data-example-id="simple-responsive-table">
        <h3>Forms Tambah Tipe Obat</h3>
        <div class="tab-content">
            <div class="tab-pane active" id="horizontal-form">
                <!-- form action -->
                <form class="form-horizontal" action="tambah_tipeobat.php">
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Id Tipe Obat</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" placeholder="Id TipeObat" name="tipeobatid" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Tipe</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1"  placeholder="tipe" name="tipe" required>
                        </div>
                    </div>
