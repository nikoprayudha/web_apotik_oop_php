...
<?php 
 ...
 if(isset($_REQUEST['submit'])){
    ...
    extract($_REQUEST);
    $obj->tambah_obat($obatid,$tipeobatid,$kategoriobatid,$nama,$tglexp,$hargabeli,$hargajual,$stok);
    }
?>
...
<div class="graphs">
    <div class="bs-example4" data-example-id="simple-responsive-table">
        <h3>Forms Tambah Obat</h3>
        <div class="tab-content">
            <div class="tab-pane active" id="horizontal-form">
                <!-- form action -->
                <form class="form-horizontal" action="tambah_obat.php">
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Id Obat</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" placeholder="Id Obat" name="obatid" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                       ...
                       <div class="col-sm-8">
                        <select class="form-control1" name="tipeobatid" required>
                                <option value ="">---PILIH ID TYPE OBAT ---</option>
                      ...
                      <div class="form-group">
                       ...
                       <div class="col-sm-8">
                        <select class="form-control1" name="kategoriobatid" required>
                                <option value ="">---PILIH ID KATEGORI OBAT ---</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control1"  placeholder="Nama Obat" name="nama" required>
                        </div>
                    </div>
                     <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Tanggal Expired</label>
                        <div class="col-sm-8">
                            <input type="date" class="form-control1"  name="tglexp" required>
                        </div>
                    </div>
                     <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Harga Beli</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1"  placeholder="Harga Beli" name="hargabeli" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Harga Jual</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1"  placeholder="Harga Jual" name="hargajual" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Stok</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1"  placeholder="Stok" name="stok" required>
                        </div>
                    </div>
