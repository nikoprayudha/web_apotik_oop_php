...
$obj->supplier();
?>
<a href="tambah_supplier.php" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-plus-sign tag_01"></span>Tambah Data</a>
<a href="export_supplier.php" class="btn btn-sm btn-info"><span class="glyphicon glyphicon-print tag_01"></span>Cetak</a>
<br><br>
...
<tbody>
    <tr>
        ...
        <td>
        <a href="update_supplier.php?idSupplier=<?php echo $idSupplier;?>"><img src="images/pencil.gif"></a>&nbsp;
        <a href="delete_supplier.php?idSupplier=<?php echo $idSupplier;?>" 
