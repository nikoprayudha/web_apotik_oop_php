...
$obj->tipe_obat();
?>
<a href="tambah_tipeobat.php" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-plus-sign tag_01"></span>Tambah Data</a>
<br><br>
...
<tbody>
    <tr>
        <td><?php echo $idTipeobat; ?></td>
        <td><?php echo $tipe; ?></td>
        <td>
        <a href="update_tipeobat.php?idTipeobat=<?php echo $idTipeobat;?>"><img src="images/pencil.gif"></a>&nbsp;
        <a href="delete_tipeobat.php?idTipeobat=<?php echo $idTipeobat;?>" 
